                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white">+1 (123) 456-7890</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white">123 Innovation St.<br />Tech City, TC 10001</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <AnimatedElement animation={{ type: 'slide-up', delay: 400 }}>
              <div className="bg-white dark:bg-dark-background p-6 rounded-lg shadow-md">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-dark-primary transition-colors duration-300">
                    {/* Twitter/X Icon */}
